...
import { fmtAmount, fmtDateTime, truncMiddle } from "@/lib/format";
import { useLoad } from "@/lib/use-load";
import { cn } from "@/lib/utils";
import type { Transaction, TxStatus, TxType } from "@/mocks/types";
  ...
  return (
    <div>
      <PageHeader
        eyebrow="wallet"
        title="Transactions"
        subtitle="Every payment, deposit, and transfer your agents have made."
        actions={
            ...
            <>
              ...
              <div className="mt-6 space-y-5">
                  ...
                  <ul className="space-y-1.5">
                    {selected.operations.map((op, i) => (
                      <li key={i} className="rounded-lg border border-border px-3 py-2 text-[13px]">
                        ...
                        <span className="ml-2 text-muted-foreground">{op.detail}</span>
                      </li>
                    ))}
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <pre className="card-edge overflow-x-auto rounded-lg border bg-elevated/60 p-3 font-mono text-xs leading-relaxed text-muted-foreground">
