...
import { fmtAmount, fmtDate, fmtUSD, timeAgo, truncMiddle } from "@/lib/format";
          ...
          <Card className="max-w-xl p-6">
            {!reputation ? (
              ...
              <div className="flex flex-col gap-6 sm:flex-row sm:items-start">
                <ScoreRing score={reputation.score} size={132} label="of 1000" />
                <div className="flex-1 space-y-3">
                  <p className="text-sm text-muted-foreground">
                    {agent.name} inherits the workspace&apos;s Stellar8004 identity. Component
                    breakdown:
                  </p>
