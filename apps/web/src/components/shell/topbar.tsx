...
import { Bell, Check, Globe, Menu, Moon, Search, Sun } from "lucide-react";
    ...
    <header className="sticky top-0 z-30 flex h-14 shrink-0 items-center gap-3 border-b border-border bg-background/85 px-4 backdrop-blur">
      ...
      <div className="flex flex-1 justify-center">
        <button
          ...
          className="flex h-8 w-full max-w-md items-center gap-2 rounded-full border border-border bg-surface px-3.5 text-sm text-muted-foreground transition-colors hover:border-input hover:text-foreground"
        >
